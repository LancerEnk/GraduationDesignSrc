...
// var myContractInstance = MyContract.at("0x4a2a01f30a7214a694479f3ecc10faca8fa86e8d");
// var account = "0x6d579e67e7a4658b611895c76cefcac905cd3b1d";
// newTaxiSystem
var myContractInstance = MyContract.at("0x3ae00d288251ffaddc2380019ffcb04d6db839a6");
...
// var map_file = "./debug_ninemap_GeoHash.json";
// real map :
...
async function add_oneline(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, gas, retry_times) {
	...
	await myContractInstance.add_onetype(gid, minzoom, cost, source, target, oneway, building, highway, name, gtype, path, { from: account, gas: gas, position: "wx411111111111", txtime: 278000 }).then(function (result) {
		// console.log("test?");    // --msj to debug
		console.log("gid: ", gid);
		console.log("path: ", path);
		// console.log("path[0]: ",path[0]);			// --msj to debug
		// console.log("sGtG:", sGtG[path[0]]);    // --msj to debug
		// console.log("tGtG:", geotogid.tGtG[path[path.length-1]);    // --msj to debug
