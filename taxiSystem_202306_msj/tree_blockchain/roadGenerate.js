...
let gname = './debug_ninemap_GeoHash.json';
...
function generateRoad(){
	rowCol(3,3);
	console.log("the max lat distance is: ",getDistanceBtwP(0, 0, 6*0.0054931640625, 0)," m");
	console.log("the max lon distance is: ",getDistanceBtwP(0, 0, 0, 6*0.0054931640625)," m");
