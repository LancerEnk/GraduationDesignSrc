...
//Map contract
let mapContractAddress = '0xbc3575d5fa69abb1dbe4ba2b24d72056be19af65';
let mapContractAbi = JSON.parse(fs.readFileSync('./mapAbi_old.json', 'utf-8'));
let mapContract = new web3.eth.Contract(mapContractAbi,mapContractAddress);

//Traffic contract
let trafficContractAddress = '0x62e0e9fe3f27f78ad255f662e875c29e24a16b48';
...
fs.writeFileSync("./vehicleTimeInfo_old.json","[",{flag:'w',encoding:'utf-8',mode:'0666'},function(err){});
fs.writeFileSync("./wayInfo_old.json","[",{flag:'w',encoding:'utf-8',mode:'0666'},function(err){});
initVehicle();
// deleteVehicle();
// getVehicleIdList();
	...
	trafficContract.events.payEvent(function(error, event){
		...
		if(event.returnValues.vehicleId.slice(0,42) == vehicleId.toLowerCase()){
            ...
            trafficContract.methods.initVehicle(vehicleId, web3.utils.asciiToHex(vehicleMessage.endGeohash)).send({from: vehicleId, gas: 500000,position: vehicleMessage.endGeohash, txtime:Date.now()}).then(function(result){
				...
				fs.writeFileSync("./vehicleTimeInfo_old.json",JSON.stringify(gasInfo),{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
				fs.writeFileSync("./vehicleTimeInfo_old.json",",",{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
				fs.writeFileSync("./vehicleTimeInfo_old.json",JSON.stringify(timeInfo),{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
				fs.writeFileSync("./wayInfo_old.json",JSON.stringify(astarInfo),{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
                if(countNum == systemNum){
					console.log("finish");
					fs.writeFileSync("./vehicleTimeInfo_old.json","]",{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
					fs.writeFileSync("./wayInfo_old.json","]",{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
					// process.exit(1);
				}else{
					fs.writeFileSync("./vehicleTimeInfo_old.json",",",{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
					fs.writeFileSync("./wayInfo_old.json",",",{flag:'a',encoding:'utf-8',mode:'0666'},function(err){});
